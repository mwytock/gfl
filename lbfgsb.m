function [x,f,info] = lbfgsb( fcn, stats, l, u, opts )
% x = lbfgsb( fcn, l, u )
...
printEvery  = setOpts( 'printEvery', 20 );
...
width       = width + 3; % include fcn and norm(grad) as well
...
for k = 1:maxTotalIts
  ...
  if cputime-t_start > opts.max_time
    ...
    elseif 1 == strfind( task, 'NEW_X' )
        ...
        err(outer_count,3)  = cputime;
        err(outer_count,4)  = stats(x);
        err(outer_count,5)  = cputime;
