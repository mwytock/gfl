%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% This script runs GFLseg on the lung dataset (see data directory for more
...
disp('Automatic analysis of a set of lung cancer CGH profiles')
...
for c=1:chr.nchrs
    ...
    % Optionally, remove singletons (intervals of length 1)
...
subplot(3,1,1)
plotChromosome(chr,Y(:,1),{'.b'})
hold on
plot(smooth(:,1),'k-','LineWidth',2)
hold off
...
subplot(3,1,3)
plotChromosome(chr,updown,{'-g','-r'},[-1.5;1.5])
